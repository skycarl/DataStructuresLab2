...
public class Stack {
     ...
     * @throws StackOverflow An error indicating potential improper use or error condition of the stack.
     */
     ...
     * @throws StackUnderflow An error indicating potential improper use or error condition of the stack.
     */
